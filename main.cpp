...
int main(void)
{
    ...
    {
        // baza piramide
        -0.5f, 0.0f, -0.5f,  0.0f, -1.0f,  0.0f, // A
         0.5f, 0.0f,  0.5f,  0.0f, -1.0f,  0.0f, // B
    ...
    glm::vec3 cameraPos = glm::vec3(0.0f, 3.0f, 0.0f);      // menjamo koordinate na y osi kako bismo dobili pogled iz pticije perspektive
    glm::vec3 cameraTarget = glm::vec3(0.0f, 0.0f, 0.0f);
    glm::vec3 cameraUp = glm::vec3(0.0f, 0.0f, -1.0f);      // podesavamo sta je "gore"
    ...
    glEnable(GL_CULL_FACE); // face-culling => vidljiva je samo prednja strana piramide
